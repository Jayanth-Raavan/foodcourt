...
export const GetNonVegItems: any = createAsyncThunk(
  "GetNonVegItems",
  async () => {
...
export const AddUserCart: any = createAsyncThunk(
  "AddUserCart",
  async (payload: any) => {
...
export const DeleteItembyId: any = createAsyncThunk(
  "DeleteItembyId",
  async (item: any) => {
...
export const EmptyCart: any = createAsyncThunk("EmptyCart", async (userId) => {
  const response = await _EmptyCart("userCart", userId);
  return null;
});